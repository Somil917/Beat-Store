...
const UserEdit = () => {
    ...
    return ( 
        <div className="w-[330px] h-[440px] p-4 flex flex-col gap-3
        drop-shadow-lg
        items-center bg-[#141414] rounded-md">
                <div className=" w-32 relative h-32 overflow-hidden border border-neutral-700 rounded-full ">
                    <Image className="object-cover" fill src={avatar_url || '/images/UserProfile.jpg'} alt="profile"/>
                </div>
                <div >
                    <p className="text-2xl font-semibold">{userDetails?.display_name}</p>
                </div>
                <div onClick={handleClick} className="w-full cursor-pointer mt-1">
